                ...
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td onclick="window.location.href = '{{ route('pra_kasus.show', $pk->id_pra_kasus) }}';">{{
                                $pk->judul_kasus }}</td>
                            {{-- <td>{{ $pk->terlapor }}</td>
                            <td>{{ $pk->korban }}</td> --}}
                            ...
                            <td>
                                ...
                                <div class="form-inline">
                                    ...
                                    @if ($pk->kasus->anggotaTim()->count() == null)
                                    <a href="{{ route('team.create', $pk->id_pra_kasus) }}"
                                        class="btn btn-success mr-2">Set Team</a>
                                    @else
                                    <a href="{{ route('team.edit', $pk->id_pra_kasus) }}"
                                        class="btn btn-primary mr-2">Edit Team</a>
                                    @endif
                                    {{-- <a href="{{route('pelapor_kasus.destroy',$pk->id_pelapor)}}"
