    ...
    <div class="container">
        <div class="card mt-5">
            ...
            <div class="card-body">
                ...
                <form method="post" action="/pra_kasus/update/{{ $pra_kasus->id_pra_kasus }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="username" class="form-control" placeholder="Tuliskan nama Anda" value="{{$pra_kasus->user->name}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="judul_kasus" class="form-control"
                            placeholder="Tuliskan judul kasus" value="{{$pra_kasus->judul_kasus}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-inline">
                            <input type="date" name="tgl_kejadian" class="form-control" value="{{date('Y-m-d', strtotime($pra_kasus->waktu_kejadian))}}">
                            <input type="time" name="time_kejadian" class="form-control" value="{{date('H:i:s', strtotime($pra_kasus->waktu_kejadian))}}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input name="terlapor" class="form-control" placeholder="tuliskan terlapor" value="{{$pra_kasus->terlapor}}"/>
                    ...
                    <div class="form-group">
                        <label>korban</label>
                        <input name="korban" class="form-control" placeholder="tuliskan korban" value="{{$pra_kasus->korban}}" />
                    ...
                    <div class="form-group">
                        ...
                        <div id="table-saksi" class="form-inline" style="width: 550px">
                            ...
                            <div class="form-inline" id="body-saksi" style="width: 550px">
                                ...
                                <input name="addMoreInputFields[{{$saksi->id_saksi}}][nama]" id="nama_1" class="form-control mr-2 mb-2"
                                    placeholder="tuliskan nama saksi" value="{{$saksi->nama}}"/>
                                <label id="label-umur">umur:&nbsp;&nbsp; </label>
                                <input name="addMoreInputFields[{{$saksi->id_saksi}}][umur]" id="umur_1" type="number"
                                    class="form-control mb-2" placeholder="umur saksi" value="{{$saksi->umur}}"/>
                            </div>
                            @endforeach
                        </div>
